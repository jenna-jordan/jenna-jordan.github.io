...
---
{% include figure.liquid path="assets/img/header_moreaboutme.jpg" class="img-fluid rounded z-depth-1" %}
...
{% include figure.liquid path="assets/img/korea_kindies.jpg" class="img-fluid rounded z-depth-1" %}
...
{% include figure.liquid path="assets/img/profilepic_rome.jpg" class="img-fluid rounded z-depth-1" %}
